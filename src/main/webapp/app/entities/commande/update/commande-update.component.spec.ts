...
describe('Commande Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call CarteBancaire query and add missing value', () => {
      ...
      const carteBancaire: ICarteBancaire = { id: 59868 };
      commande.carteBancaire = carteBancaire;

      const carteBancaireCollection: ICarteBancaire[] = [{ id: 47296 }];
      jest.spyOn(carteBancaireService, 'query').mockReturnValue(of(new HttpResponse({ body: carteBancaireCollection })));
      const additionalCarteBancaires = [carteBancaire];
    ...
    it('Should update editForm', () => {
      const commande: ICommande = { id: 456 };
      const carteBancaire: ICarteBancaire = { id: 72406 };
      commande.carteBancaire = carteBancaire;

...
type CategoryFormDefaults = Pick<NewCategory, 'id' | 'produits'>;

type CategoryFormGroupContent = {
  id: FormControl<ICategory['id'] | NewCategory['id']>;
  idCategory: FormControl<ICategory['idCategory']>;
  nom: FormControl<ICategory['nom']>;
  produits: FormControl<ICategory['produits']>;
};
...
export class CategoryFormService {
  createCategoryFormGroup(category: CategoryFormGroupInput = { id: null }): CategoryFormGroup {
    ...
    return new FormGroup<CategoryFormGroupContent>({
      ...
      idCategory: new FormControl(categoryRawValue.idCategory),
      nom: new FormControl(categoryRawValue.nom),
      produits: new FormControl(categoryRawValue.produits ?? []),
    });
  }

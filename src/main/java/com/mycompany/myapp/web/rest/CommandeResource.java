...
public class CommandeResource {
    ...
    public ResponseEntity<CommandeDTO> createCommande(@RequestBody CommandeDTO commandeDTO) throws URISyntaxException, CarteBancaireNotValidException, OutOfStockException {
